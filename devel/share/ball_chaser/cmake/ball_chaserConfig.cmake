...
if(NOT "/home/khyeon/workspace/019_MapMyWorld/devel/include " STREQUAL " ")
  set(ball_chaser_INCLUDE_DIRS "")
  set(_include_dirs "/home/khyeon/workspace/019_MapMyWorld/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ball_chaser' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/khyeon/workspace/019_MapMyWorld/src/ball_chaser/${idir}'.  ${_report}")
    endif()
